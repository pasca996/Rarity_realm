    <!-- Navbar Start -->
    <div class="container-fluid navbar-light mb-30" style="background-color: #f2f6fa">
            ...
            <div class="col-lg">
                ...
                <nav class="navbar navbar-expand-lg navbar-light py-3 py-lg-0 px-0">
                    ...
                    <a href="{{route('welcome')}}" class="text-decoration-none d-block">
                        <span class="h2 text-uppercase text-dark px-2 rounded-left"style="background-color: #32b991">Rarity</span>
                        <span class="h2 text-uppercase text-light px-2 ml-n1 rounded-right" style="background-color: #8260c2">Realm</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <form class="form-inline">
                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
                                @auth
                                <div class="nav-item dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><span class="h5"> Ciao, {{Auth::user()->name}}</span> <i
                                     class="fa fa-angle-down mt-1"></i></a>
                                    <div class="dropdown-menu rounded-5 border-0 m-0">
